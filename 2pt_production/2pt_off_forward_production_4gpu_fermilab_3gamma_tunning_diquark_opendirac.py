                ...
                for z_idx, z0 in enumerate(z_src[i_cfg]):
                    ...
                    for i_gamma_sink, gamma_sink in enumerate(gamma_list):
                        ...
                        for i_gamma_source, gamma_source in enumerate(gamma_list):
                                ...
                                proton_gamma_dirac[i_gamma_sink,i_gamma_source,:,:,t_idx,x_idx,y_idx,z_idx] += (
                                contract("abc,ij,pwtzyx,wtzyxijabf,wtzyxlkfc->lkpt",
                                           eps_color, charge @ gamma_source, momentum_phases, diquark, prop2.data)
                                - contract("abc,ij,pwtzyx,wtzyxkjcbf,wtzyxlifa->lkpt",
                                           eps_color, charge @ gamma_source, momentum_phases, diquark, prop2.data))
