...
measurement_list = cfg_list[icfg0::cfg_measure_spacing][:n]     # cfg_list[icfg0], cfg_list[icfg0 + spacing], ... first n
...
core.init([1, 1, 1, 4], resource_path="/lustre/orion/lgt132/scratch/sicheng/GLUON_ANALYSIS_MANUAL/2pt_production/.cache/quda")
