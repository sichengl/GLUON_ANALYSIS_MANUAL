                    ...
                    for i_gamma_sink, gamma_sink in enumerate(gamma_list):
                        for i_gamma_source, gamma_source in enumerate(gamma_list):
                                ...
                                proton_gamma_p[i_gamma_sink,i_gamma_source,t_idx,x_idx,y_idx,z_idx] += (contract("abc,def,gh,ij,kl,pwtzyx,wtzyxhjeb,wtzyxgida,wtzyxlkfc->pt",
                                    eps_color,eps_color,charge @ gamma_sink, charge @ gamma_source_bar, parity_p,momentum_phases, prop2.data,prop2.data,prop2.data)
                                -
                                contract("abc,def,gh,ij,kl,pwtzyx,wtzyxhjeb,wtzyxgkdc,wtzyxlifa->pt",
                                    eps_color,eps_color,charge @ gamma_sink, charge @ gamma_source_bar, parity_p,momentum_phases, prop2.data,prop2.data,prop2.data))

                                proton_gamma_m[i_gamma_sink,i_gamma_source,t_idx,x_idx,y_idx,z_idx] += (contract("abc,def,gh,ij,kl,pwtzyx,wtzyxhjeb,wtzyxgida,wtzyxlkfc->pt",
                                    eps_color,eps_color,charge @ gamma_sink, charge @ gamma_source_bar, parity_m,momentum_phases, prop2.data,prop2.data,prop2.data)
                                -
                                contract("abc,def,gh,ij,kl,pwtzyx,wtzyxhjeb,wtzyxgkdc,wtzyxlifa->pt",
                                    eps_color,eps_color,charge @ gamma_sink, charge @ gamma_source_bar, parity_m,momentum_phases, prop2.data,prop2.data,prop2.data))
